...
public class BlockZoomer extends ContainerBlock {
    ...
    public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        if(itemOrEntity){
            tooltip.add(new TranslationTextComponent("block.wikizoomer.item_zoomer.desc0").func_240699_a_(TextFormatting.GRAY));
            tooltip.add(new TranslationTextComponent("block.wikizoomer.item_zoomer.desc1").func_240699_a_(TextFormatting.GRAY));
        }else{
            tooltip.add(new TranslationTextComponent("block.wikizoomer.entity_zoomer.desc0").func_240699_a_(TextFormatting.GRAY));
            tooltip.add(new TranslationTextComponent("block.wikizoomer.entity_zoomer.desc1").func_240699_a_(TextFormatting.GRAY));
        }
